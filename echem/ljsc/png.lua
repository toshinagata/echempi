...
function png.readPNG(filename, fill)
  ...
  if (color_type[0] == png.PNG_COLOR_TYPE_GRAY or color_type[0] == png.PNG_COLOR_TYPE_GRAY_ALPHA) then
    libpng.png_set_gray_to_rgb(png_ptr)
  end
  if (color_type[0] == png.PNG_COLOR_TYPE_RGB or color_type[0] == png.PNG_COLOR_TYPE_GRAY) then
    if fill ~= 0 then
